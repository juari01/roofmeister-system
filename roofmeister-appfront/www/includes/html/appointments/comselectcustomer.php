...
<div class="row">
      <div class="col-1">
		<input type="button" value="Back" class="back-appselectcustomer">
...
$( document ).ready( function() {
	...
	$(".back-appselectcustomer").off().on( 'click', function( e ) {
		e.preventDefault();
		e.stopPropagation();
	...
	function selectcustomer_search() { 
		...
		$.post( '/handlers/projects.php', values, function ( result ) {
			...
			if ( result_json.status == 'success' ) {
				...
				var addlinkcus 			 ="Select " + select_customer_name + " to this appointment?" ;
