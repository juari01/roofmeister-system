...
<div class="row">
      <div class="col-1">
	 	 <input type="button" value="Add Customer" data-function="add-customer"> 
		<span class="page_nav" data-name="page-container">%PAGES%</span>
      </div>
      <div class="col-2">
	  <span class="search"><input type="text" id="search" name="search" class="customer-search" placeholder=" search..."></span>
      </div>
</div>
