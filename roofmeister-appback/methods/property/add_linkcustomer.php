<?php namespace property;
	...
	function add_linkcustomer( $params ) {
	/**
...
SQL;
	...
	$check_result = \DB::dbh()->prepare( $check_query );
	
	
	$addlinkcustomer_query = <<<SQL
  INSERT INTO 
	xref_customer_property
		SET customer_id   = :customer_id,
			property_id	  = :property_id
SQL;

	$save = \DB::dbh()->prepare( $addlinkcustomer_query );
	

	
	$check_result->execute( array( 
